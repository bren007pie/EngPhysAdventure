...
def Reset():
    ...
    Equipment("Old Car Keys", (1,0,0,2), "CarKeys.jpg", "Fun for babies. Not for Batman.", "off-hand", (7,0,15),""),
    Equipment("Dirty Needle", (2,2,0,2), "Needle.jpg", "This isn't clean. Someone find me a SharpXchange!", "hand", (7,0,5),""),
    Equipment("Clean Needle", (None), "CleanNeedle.jpg", "No more spreadin' disease!", "hand", (25, 0, 9), ""),
    Equipment("Pizza Box", (2,1,0,2), "PizzaBox.jpg", "Fully equipped with crusted cheese.", "body", (1,5,1),3),
    ...
    # --- CAPSTONE ROOM: Dimension 2 ---
    Enemy("Dr. Minnick",
              "'Hello and welcome to " + deadpersoncolour + "8 months of HELL" + textcolour + "! MUAHAHAHA.",
    ...
    # --- CAPSTONE ROOM: Dimension 2 ---
    Interact("Rules Sign", (2,2,0,2), "It reads: (\S)THERE ARE NO RULES", "", "", "", False),
    ...
    Interact("Lake Painting", (0, 2, 0, 2), "A painting of a beautiful lake. It brings you peace.", "You feel a pull. All of a sudden you're being pulled into the painting and all around you it's getting bright. (\S)You wake up to the sound of birds chirping and a soft breeze.", "old car keys", None,True),
